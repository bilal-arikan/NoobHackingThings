...
namespace DosyaKoplayama
{
    public partial class Form1 : Form
    {
        ...
        public string kopyalanacakDosya = "";
        public string dosyanınKopyanacagiKlasor = "";
        public string kopyalanacakDosyaIsmi = "";
        ...
        public Color ChangeBackgroundColor(string color)
        {
            switch (color)
            {
                case "kırmızı":
                ...
                case "yeşil":
                    ...
                    break;
                default:
                    throw new ArgumentException("Bilinmeyen Renk !!!");
            }
            return BackColor;
        }
    }
